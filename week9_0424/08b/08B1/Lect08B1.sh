...
awk '{print $1,$2,sqrt($3*$3+$4*$4)}' velh.gmt | gmt surface -R120.1/120.7/22.25/23.0 -Gvelh.grd -I0.01 -T0.25 -C0.1 -V
...
gmt begin $prefix jpg A+m0.5c
	...
	# inset
	# gmt inset begin -DjBL+w1.5i/1.5i+o0.1i/0.1i -F+g255+p0.25p,0 -M0.002i
