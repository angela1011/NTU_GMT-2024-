# GPS station velocities in southern Taiwan
# Data: Central Geological Survey, MOEA, Taiwan
# Origninal Batch file was made by Ching Kuo-En, Department of Geomatics, NCKU
# Batch file modified by Hu Jyr-Ching, Department of Geosciences, NTU, 09/01/2008
# Batch file modified by Bo-Han Tsao, Department of Geosciences, NTU, 04/30/2020
...
# create gridfile of hori. velo.
awk '{print $1,$2,sqrt($3*$3+$4*$4)}' velh.gmt | gmt surface -R120.1/120.7/22.25/23.0 -Gvelh.grd -I0.001 -T0.25 -C0.1 -V
gmt grdsample swshad.grd -Rvelh.grd -I0.001 -Gtemp.nc -V
gmt grdinfo temp.nc > temp.nc.info
gmt grdinfo velh.grd > velh.grd.info
#
gmt begin $prefix jpg A+m0.5c
    # create basemap
	gmt grdimage velh.grd -Cvelh.cpt -Itemp.nc -Ba0.2f0.2 -BWESN -R120.1/120.7/22.25/23.0 -Jm121.0/10.5i -V
