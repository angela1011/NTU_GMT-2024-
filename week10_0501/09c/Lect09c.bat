REM set variables
set prefix=Lect09C
set range=119.0/122.5/21.5/25.5
REM configure
...
REM data processing
gawk "{print $2, $3, $4, $6, $5, $7, 0, $1}" CGPS_ITRF2008.dat > CGPS_ITRF2008.gmt
gawk "{print $1, $2, sqrt($3^2+$4^2)}" CGPS_ITRF2008.gmt > CGPS_ITRF2008_Vect.gmt
...
gmt begin %prefix% tif A+m0.5c
    ...
    REM Plot Basement High
    gmt plot basement_high.txt -W1.0p,150/80/0,- -V
    REM Plot GPS vector and stations
    ...
    REM  === inlet and locality map ===================================================================
    gmtset MAP_FRAME_WIDTH=0.001i MAP_TICK_LENGTH=0.000i
