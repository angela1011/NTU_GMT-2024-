# Psvelo: strain crosses for strain rate field in SW Taiwan
# Original batch file is from Jyr-Ching Hu, Department of Geosciences, NTU
# Edited by Bo-Han Tsao, Department of Geosciences, NTU for GMT6.0

# ========= Set variables =========
prefix=Lect09D
grd=../gridfiles/TW_20m_WGS84.nc
fault11=Category_I_WGS84.txt
fault12=Category_I_concealed_WGS84.txt
fault21=Category_II_WGS84.txt
fault22=Category_II_concealed_WGS84.txt
# ======== Set configuration ======
set FORMAT_GEO_MAP=+ddd:mm:ssG
# ====== Make cpt ======
gmt grd2cpt $grd -T0/4000/200 -Z -Cdem3 > tw_dem3.cpt
# ====== GMT plot: principal strain rate ======
