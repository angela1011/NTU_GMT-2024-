# SRTM-derived DEM
# Original batch file was made by Tseng Chia-Han following the batch file created by Chiang Jei-Jhong, Institute of Oceanography, NTU
# Batch file modified by Jyr-Ching Hu, Department of Geosciences, NTU 
# Edited by Bo-Han Tsao, Department of Gepsciences, NTU for GMT6
# set variables
prefix=Lect10B
# configure
