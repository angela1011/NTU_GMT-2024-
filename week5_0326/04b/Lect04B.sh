# Original batch file was created by teaching assistan Chiu Chun-Ying (邱俊穎) on 7 August 2007 for training course 
# #ote Sensing and Geodetic Lab, Department of Geosciences, NTU.

prefix=Lect04B
grd1=GEBCO_2023_sub_ice_topo.nc
grd2=cut.nc
cpt=sealand_mk.cpt
range=110/140/35/50
start=118/48
