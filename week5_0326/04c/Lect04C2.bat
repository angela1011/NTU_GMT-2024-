...
echo 6.2 1.1 10,1 CM M@-L@-= | gmt text -Jx -F+f+j -N -V
...
gawk "{print $1, $2, $4*0.01}" hypo_0_15.gmt | gmt plot -Sc -W0.2,250/0/0 -V
gawk "{print $1, $2, $4*0.01}" hypo_30_50.gmt | gmt plot -Sc -W0.2,250/250/0 -V 
gawk "{print $1, $2, $4*0.01}" hypo_15_30.gmt | gmt plot -Sc -W0.2,0/195/135 -V
gawk "{print $1, $2, $4*0.01}" hypo_50_80.gmt | gmt plot -Sc -W0.2,50/250/100 -V 
gawk "{print $1, $2, $4*0.01}" hypo_80_120.gmt | gmt plot -Sc -W0.2,50/200/250 -V
gawk "{print $1, $2, $4*0.01}" hypo_120_300.gmt | gmt plot -Sc -W0.2,0/0/200 -V
REM plot coast and active faults
gmt coast -Dh -W1,0 -V
