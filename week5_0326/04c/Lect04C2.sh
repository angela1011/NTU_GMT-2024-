...
echo 1.6 1.4 0.1 | gmt plot -Jx0.9 -R0/10/0/10 -Sc -W0.7,250/0/0 -X0.15 -Y1.5 -V
echo 2.3 1.4 0.1 | gmt plot -Sc -W0.7,255/195/135  -V
echo 3.1 1.4 0.1 | gmt plot -Sc -W0.7,250/250/0 -V
echo 3.9 1.4 0.1 | gmt plot -Sc -W0.7,50/250/100 -V
echo 4.7 1.4 0.1 | gmt plot -Sc -W0.7,50/200/250 -V 
echo 5.5 1.4 0.1 | gmt plot -Sc -W0.7,0/0/200 -V
# Scale text
...
# Base map and title 
gmt basemap -JM121/23/15C -R$range -Bxa1f0.5 -Bya1f0.5 -BWeSn+t'Seismicity in and around Taiwan (CWA, 1995-2014)' --FONT_TITLE=18p,16,blue --MAP_TITLE_OFFSET=2p -V -Y1.8 -X1.5
# Seismicity
...
awk '{if ($3 > 50 && $3 <= 80) print $1, $2, $3, $4 }' CWAEQs_1995-2022.gmt > hypo_50_80.gmt 
awk '{if ($3 > 80 && $3 <= 120) print $1, $2, $3, $4 }' CWAEQs_1995-2022.gmt > hypo_80_120.gmt
awk '{if ($3 > 120 && $3 <= 300) print $1, $2, $3, $4 }' CWAEQs_1995-2022.gmt > hypo_120_300.gmt
awk '{print $1, $2, $4*0.01}' hypo_0_15.gmt | gmt plot -Sc -W0.2,250/0/0 -V
awk '{print $1, $2, $4*0.01}' hypo_30_50.gmt | gmt plot -Sc -W0.2,250/250/0 -V 
awk '{print $1, $2, $4*0.01}' hypo_15_30.gmt | gmt plot -Sc -W0.2,0/195/135 -V
awk '{print $1, $2, $4*0.01}' hypo_50_80.gmt | gmt plot -Sc -W0.2,50/250/100 -V 
awk '{print $1, $2, $4*0.01}' hypo_80_120.gmt | gmt plot -Sc -W0.2,50/200/250 -V
awk '{print $1, $2, $4*0.01}' hypo_120_300.gmt | gmt plot -Sc -W0.2,0/0/200 -V
# plot coast and active faults
gmt coast -Dh -W1,0 -V
