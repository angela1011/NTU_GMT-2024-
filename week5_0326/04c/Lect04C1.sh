...
awk '{print $1, $2, $4*0.01}' hypo_50_80.gmt | gmt plot -Sc -G50/250/100 -W0.2 -V 
awk '{print $1, $2, $4*0.01}' hypo_80_120.gmt | gmt plot -Sc -G50/200/250 -W0.2 -V
awk '{print $1, $2, $4*0.01}' hypo_120_300.gmt | gmt plot -Sc -G0/0/200 -W0.2 -V
gmt coast -Dh -W1,0 -V
