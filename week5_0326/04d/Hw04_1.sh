...
gmt subplot begin 2x1 -Fs15c/10c -A -M2c
gmt subplot set 0 -A'(a)'
gmt basemap -JM121/23/15c -R$range -Y5c -V --FONT_TITLE=18p,16,blue --MAP_TITLE_OFFSET=2p 
gmt grdimage $grd2 -Ctopo_gray.cpt -I+a300-V -Bxa0.2f0.1 -Bya0.2f0.1 -BWeSn+t'R12224203 seismicity' 
...
cat minmax.out
gmt plot track_profile.txt -R0/100/0/1200 -JX? -Bxa50f10+l'Distance (km)' -Bya400f200+l'H (m)' -BSWne -W2p,red -V
