...
REM Export shorelines of Taiwan
REM set area=30000
REM gmt coast -R%range% -A%area% -Df -W -M > Tw_shoreline.txt
gmt coast -ETW -M -V > Tw_shoreline.txt
...
gmt begin %prefix% jpg A+m0.5c
    ...
    gmt clip -C -V
    gmt plot Tw_shoreline.txt -W1.5p,black -V
