...
grd1=../grdfiles/Taiwan40m_WGS84.nc
grd2=tw_sw40.grd
...
gmt begin $prefix jpg A+m0.5c
    ...
    echo 120.78	22.74 15 161.12	36.65 114.09 5.4 120.85 22.7 2012/2/26 | gmt meca -Sa1c+f10p+o3p -Fa4p/cc -Zfd_blue+.cpt -A -L -N -V
